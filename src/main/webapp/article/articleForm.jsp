...
<form name = "articleForm" method = "post" action = "${contextPath}/board/addArticle.do" entype="multipart/form-data">
<table>
<tr>
...
<input type="file" name = "imageFileName" onchange = "readURL(this);" /></td></tr>
<td>
